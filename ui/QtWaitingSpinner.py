...
from PyQt6.QtCore import pyqtSlot, QRectF, QTimer, Qt
from PyQt6 import QtCore
from math import ceil
from PyQt6.QtWidgets import QDialog

# This class is copied from Stack Overflow and modified a bit to fix compile errors.
class QtWaitingSpinner(QDialog):
    mColor = QColor(1, 0, 0)
    mRoundness = 100.0
    ...
    def updateTimer(self):
        self.timer.setInterval(
            1000.0 / (self.mNumberOfLines * self.mRevolutionsPerSecond)
        )
    ...
    def paintEvent(self, event):
        ...
        painter.fillRect(self.rect(), QColor(1, 0, 0, 0))
        ...
        for i in range(self.mNumberOfLines):
            ...
            painter.drawRoundedRect(
                QRectF(0, -self.mLineWidth // 2, self.mLineLength, self.mLineLength),
                self.mRoundness,
                self.mRoundness,
